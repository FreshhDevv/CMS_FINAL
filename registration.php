                    ...
                    <div class="form-wrap">
                        ...
                        <form role="form" action="registration.php" method="post" id="login-form" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="user_firstname" id="user_firstname" class="form-control" placeholder="Enter First Name" autocomplete="on" value="<?php echo isset($user_firstname) ? $user_firstname : '' ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="user_lastname" id="user_lastname" class="form-control" placeholder="Enter Last Name" autocomplete="on" value="<?php echo isset($user_lastname) ? $user_lastname : '' ?>">
